...
from object_detection.models import ssd_custom_mobilenet_v2_feature_extractor
...
class SsdCustomMobilenetV2FeatureExtractorTest(
  ...
  def _create_feature_extractor(self,
    ...
    if use_keras:
      ...
      return ssd_custom_mobilenet_v2_feature_extractor.SSDCustomMobileNetV2FeatureExtractor(
          False,
          custom_conv_def,
          depth_multiplier,
          min_depth,
